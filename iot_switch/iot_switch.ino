...
#define AUTH "FE_pFBwqeBoBEdLsdmlix-k5l7yQKTz"                 // You should get Auth Token in the Blynk App.  
#define WIFI_SSID "JioFi2_D100E64"             //Enter Wifi Name
#define WIFI_PASS "REDMI Y1"         //Enter wifi Password
